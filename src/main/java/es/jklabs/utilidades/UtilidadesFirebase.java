...
public class UtilidadesFirebase {
    ...
    private static final String REFERENCE = "aplicaciones/SonarQubeLauncher";
    ...
    private static boolean diferenteVersion(String serverVersion) {
        ...
        return Integer.parseInt(sv[0]) > Integer.parseInt(av[0]) || Integer.parseInt(sv[0]) == Integer.parseInt(av[0]) &&
                (Integer.parseInt(sv[1]) > Integer.parseInt(av[1]) || Integer.parseInt(sv[1]) == Integer.parseInt(av[1]) &&
                        Integer.parseInt(sv[2]) > Integer.parseInt(av[2]));
    }
